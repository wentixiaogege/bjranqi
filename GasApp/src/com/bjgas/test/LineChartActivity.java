...
public class LineChartActivity extends GasBase implements OnChartGestureListener,
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		//
		// ArrayList<LineDataSet> sets = (ArrayList<LineDataSet>)
		// mChart.getDataCurrent().getDataSets();
		//
