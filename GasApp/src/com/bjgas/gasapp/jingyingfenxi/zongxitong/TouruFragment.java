...
@SuppressLint("NewApi")
public abstract class TouruFragment extends JingyingFragments<AllInputBean> {


	private static final String TAG_ZONGJIEGOUCHART = "TouruFragment";
