...
public abstract class JingyingFragments<T> extends BaseFragment<T> {
	...
	protected String getSearchRequestUrl(String startMonth, String endMonth) {
		String mRequestUrl = String.format(FORMAT_URL_WITHDATE, REQUEST_WEBSITE, JINGYING_CATEGORY, getModule(),
				startMonth, endMonth);
		return mRequestUrl;
	}
